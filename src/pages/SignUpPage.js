    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="flex flex-col w-full max-w-5xl overflow-hidden bg-white shadow-lg rounded-xl md:flex-row">
        ...
        <div className="flex flex-col items-center justify-center p-8 md:w-1/2 bg-gradient-to-br from-white to-gray-100">
          ...
          />
          <h2 className="w-full mb-2 text-2xl font-bold text-gray-800">Join the world's largest community of young travelers</h2>
          <p className="w-full text-gray-500">Connect with fellow adventurers, share your stories, and plan your next big adventure.</p>
        </div>
        {/* Right: Sign Up Form */}
          ...
          <form className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Choose a username" className="w-full py-2 pl-10 pr-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200" />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" placeholder="Enter your email" className="w-full py-2 pl-10 pr-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200" />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" placeholder="Create a password" className="w-full py-2 pl-10 pr-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200" />
              </div>
            </div>
            <div className="flex items-center">
              <input type="checkbox" className="mr-2 text-blue-500 rounded form-checkbox" />
              <span className="text-sm text-gray-700">I agree to the <a href="#" className="text-blue-500 hover:underline">Terms of Service</a> and <a href="#" className="text-blue-500 hover:underline">Privacy Policy</a></span>
            </div>
            <button type="submit" className="w-full py-2 mt-2 font-semibold text-white bg-blue-500 rounded-lg hover:bg-blue-600">Create Account</button>
          </form>
